...
import AD_Accounts from './AD_Accounts';

const AD_AssetTransfer2 = () => {
                ...
                {filteredEmployees.length === 0 ? (
                  ...
                  filteredEmployees.map((employee, index) => (
                    <tr
                      ...
                      onClick={() => navigate(
                        `/ad-asset-transfer-3?user_id=${employee.id}&from_officer=${encodeURIComponent(employee.name)}&department=${encodeURIComponent(employee.department)}`
                      )}
                    >
...
export default AD_AssetTransfer2;