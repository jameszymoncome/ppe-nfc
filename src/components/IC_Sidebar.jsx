          ...
          <ul className="space-y-2">
            ...
            <li>
              <NavLink
                to="/ic-par-ics"
                className={({ isActive }) =>
                  `${navLinkClass} hover:bg-gray-100 ${pathname.startsWith('/ic-par-ics') || pathname.startsWith('/property-assignment') ? activeClass : ''}`
                }
              >
            ...
            <li>
              <NavLink
                ...
                className={({ isActive }) =>
                  `${navLinkClass} hover:bg-gray-100 ${pathname.startsWith('/ic-asset-transfer') || pathname.startsWith('/ic-asset-transfer-3') ? activeClass : ''}`
                }
              >
